...
<template>
    <OtherLanding active="/contact" :image="image" bread="Contact Us" title="Contact Us" />
            ...
            <div class="holder">
                <div class="circle first">
                    <div class="inner">
                        ...
                        <span>Hotline 112-110-5</span>

                        <div class="image-holder">
                            <img src="../public/images/background/circle-back1.png">
                        </div>
                        <div class="line">
                            <span>01</span>
                            <hr>
                ...
                <div class="circle second">
                    <div class="inner">
                        ...
                        <span>anandchildrenhospital@gmail.com</span>
                        <span>| support@info.com</span>

                        <div class="image-holder">
                            <img src="../public/images/background/circle-back2.png">
                        </div>
                        <div class="line">
                            <hr>
                            <span>02</span>
                ...
                <div class="circle third">
                    <div class="inner">
                        ...
                        <div class="image-holder">
                            <img src="../public/images/background/circle-back3.png">
                        </div>
                        <div class="line">
                            <span>03</span>
                            <hr>
    ...
    <section class="contact-area">
        <div class="page">
            <form>
                ...
                <WidgetButton type="submit"><span>Send Message</span></WidgetButton>
            </form>
                ...
                <div class="map">
                    ...
                    <div class="card">
                        ...
                        <div class="rating">
                            ...
                            <span>925 Reviews</span>
                        </div>

                        <a href="#">View Larger Map</a>

                        <img class="direction" src="../public/images/icons/direction.png" alt="direction">
                    </div>
                </div>
            </div>
        </div>
